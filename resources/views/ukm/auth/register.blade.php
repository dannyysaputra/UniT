                ...
                <div class="register-ukm mt-5">
                    <div class="row" style="width: 950px">
                                    ...
                                    <div class="col-9" style="flex-direction: row-reverse">
                                        <label class="file-upload-label">
                                            <div class="file-upload-design">
                                                ...
                                                <input class="@error('logo') is-invalid @enderror"
                        ...
                        <div class="group8">
                            ...
                            <input required="true8" class="main-input9 @error('link_grup') is-invalid @enderror"
                                type="text" name="link_grup" id="link_grup" />
                            <span class="highlight-span8"></span>
                            @error('link_grup')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="group8">
                            ...
                            <input required="true8" class="main-input9 @error('instagram') is-invalid @enderror"
                        ...
                        <div class="group8">
                            ...
                            <input required="true8" class="main-input9 @error('telepon') is-invalid @enderror"
                                ...
                                <div class="col-2">
                                    <div class="card card-kepengurusan">
                                        <svg style="cursor: pointer" width="80" height="80"
                                            ...
                                            <rect x="15.5" y="68.5" width="18" height="89" rx="9"
                                                transform="rotate(-90 15.5 68.5)" fill="#D64838"
                                                data-bs-toggle="modal" data-bs-target="#exampleModalCenter" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div class="file-upload-design">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="60"
                                        ...
                                        <path
                                            ...
                                            fill="url(#paint0_linear_790_1359)" />
                                        <defs>
                                            <linearGradient id="paint0_linear_790_1359" x1="52" y1="-51.5"
                                                x2="52" y2="137.5" gradientUnits="userSpaceOnUse">
                                                <stop offset="0.0572917" stop-color="white" />
                                                <stop offset="0.791667" stop-color="#DB5F1E" />
                                            </linearGradient>
                                        </defs>
                                    ...
                                    <span class="browse-button"><b>Browse</b><input type="file"
                                            class="@error('pengesahan') is-invalid @enderror" name="pengesahan"
                                            id="pengesahan" /></span>
